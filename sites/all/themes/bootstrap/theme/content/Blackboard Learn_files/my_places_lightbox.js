...
MpLightbox.prototype = {
  ...
  activate: function(){
    ...
    {            
      ...
      if((doctype && doctype.name.toLowerCase() != 'html' && browser == 'Firefox') || ( !doctype && browser != 'Internet Explorer'))
      {
  ...
  deactivate: function(){
    ...
    var wrapper = this.bigFrame.document.getElementById('lightboxWrapper');
    wrapper.parentNode.removeChild( wrapper );
    var overlay = this.bigFrame.document.getElementById('overlay');
